...
<head>
    ...
    <title>Confirmacao de Email</title>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                                ...
                                                <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;">
                                                    <tr  >
                                                        <td align="left" class="center-text">
                                                            <a href="{{ url('/') }}"><img style="width:72px;border:0px;display: inline!important;" src="https://cdn.discordapp.com/attachments/805156640567197720/1291562310187614320/Email-2_Intro.png?ex=67008ca2&is=66ff3b22&hm=7970b2a507214c49a8519fa79230491a453ce39d4f19f163e0c377b9c3c9e367&" width="72" border="0"  alt="{{ config('app.name') }}"></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
                            ...
                            <tr  >
                                <td align="center" class="center-text">
                                    <img style="width:190px;border:0px;display: inline!important;" src="https://cdn.discordapp.com/attachments/805156640567197720/1291562995679236137/Email-4_Intro.png?ex=67008d46&is=66ff3bc6&hm=eab0f6ca32dedc164d73222c9a90d42f6e4170f725a14531aab7ca88b7314ee0&" width="190" border="0"       alt="intro">
                                </td>
                            </tr>
                            <tr  >
                                <td height="40" style="font-size:40px;line-height:40px;" >&nbsp;</td>
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:42px;line-height:52px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                        ...
                                        Seu Login esta quase finalizado {{$name}}!
                            ...
                            <tr  >
                                <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                        ...
                                        Seu acesso esta quase finalizando, use o codigo abaixo para verificar seu email 
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                                        <tr>
                                            <td align="center"    bgcolor="#d6df58" style="border-radius: 6px;">
                                                ...
                                                <p target="_blank"    style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:25px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>{{$codigo}}</span></p>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            ...
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="{{ config('pleb.mail.facebook_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="https://cdn.discordapp.com/attachments/805156640567197720/1291565011075989545/Facebook.png?ex=67008f26&is=66ff3da6&hm=02b5584ea4d12e7a86d1208994d8e891ef9b7a67f8edb586b95f9f1a94bdc561&" width="36" border="0"       alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            ...
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="{{ config('pleb.mail.instagram_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="https://cdn.discordapp.com/attachments/805156640567197720/1291565011344297984/Instagram.png?ex=67008f26&is=66ff3da6&hm=19ec9b7efbb329068dffb8bde94f825d554d601f30615f6189f2fd96de840209&" width="36" border="0"       alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="{{ config('pleb.mail.twitter_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="https://cdn.discordapp.com/attachments/805156640567197720/1291565011830964235/Twitter.png?ex=67008f26&is=66ff3da6&hm=926a8643828cf12a44d74094ba0038864507f838f2ec6f5f9f0059a91e8bdfc4&" width="36" border="0"       alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td   class="rwd-on-mobile" align="center" valign="middle" height="36" style="height: 36px;">
                                                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                                <tr>
                                                                    <td width="10"></td>
                                                                    <td align="center">
                                                                        <a href="{{ config('pleb.mail.pinterest_url') }}"><img style="width:36px;border:0px;display: inline!important;" src="https://cdn.discordapp.com/attachments/805156640567197720/1291565011600408586/Pinterest.png?ex=67008f26&is=66ff3da6&hm=b2389d8d175e8791f65addf7abc944e0dbd8591c1744f4bb0db227a1e77c5b1b&" width="36" border="0"       alt="icon"></a>
                                                                    </td>
                                                                    <td width="10"></td>
                                                                </tr>
                                                            </table>
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr  >
                                                        <td align="center">
                                                            <a href="{{config('pleb.mail.ios_url')}}"><img style="display:block;width:100%;max-width:117px;border:0px;"    width="117" src="https://cdn.discordapp.com/attachments/805156640567197720/1291566304276381716/App-Store.png?ex=6700905b&is=66ff3edb&hm=ae8d625f4306e07b4359f4ac0acf3234b33e2c0176982f49b9a4bd41b63a2e50&" border="0"  alt="icon"></a>
                                                        </td>
                                                        <td width="10" style="width: 10px;"></td>
                                                        <td align="center">
                                                            <a href="{{config('pleb.mail.play_url')}}"><img style="display:block;width:100%;max-width:117px;border:0px;"    width="117" src="https://cdn.discordapp.com/attachments/805156640567197720/1291566402683277393/Google-play.png?ex=67009072&is=66ff3ef2&hm=add8e4062c1768457088f20a8d297321f2ab8725c08e0c97c6971fd980620c83&" border="0"  alt="icon"></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <!-- column -->
